export const zhCN = {
  ...
  details: {
    ...
    pinHistory: "固定历史版本",
    unpinHistory: "取消固定历史版本",
    expandHistory: "展开历史版本",
    collapseHistory: "收起历史版本",
  ...
  log: {
    ...
    openNoDefaultApp: "蓝天嗨彩文档管理 无法用系统默认程序打开「{name}」。通常是因为系统未为该文件类型（.docx/.xlsx/.pptx）关联默认程序，或关联的程序启动失败。请在系统设置中为该扩展名关联一个 Office 程序（如 Word/WPS/LibreOffice）后重试。详细错误：{error}",
  ...
  connect: {
    ...
    backendResticOnly: "新建仓库使用 restic 后端（加密、去重备份）。",
    submit: "连接 / 初始化",
    title: "创建或打开仓库",
    ...
    unrecognized: "目录非空且不是可识别的 蓝天嗨彩文档管理 仓库。",
  ...
  archive: {
    ...
    description:
      "蓝天嗨彩文档管理 通过解包 OOXML 后交由备份后端做版本级快照与内容去重。当前后端与仓库位置如下：",
    currentBackend: "当前后端",
    repositoryDir: "仓库目录",
    dataDir: "暂存目录",
